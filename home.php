...
while($i<$num)
	...
	if($curr_time-$time >= 50 && $clear==0)			//vechicle is not present and booking time exceeded
	{
  ...
  <ol class="cabin fuselage">
    <li class="row row--1">
      <ol class="cars" type="A">
        <li class="car">
          <input type="checkbox" id="5A" value="5A" name="check" <?php if($flag[5] || $bookflag[5]) echo 'disabled'; ?>/>
    ...
    <li class="row row--2">
      <ol class="cars" type="A">
        <li class="car">
          <input type="checkbox" id="4A" name="check" value="4A" <?php if($flag[4] || $bookflag[4]) echo 'disabled'; ?> />
    ...
    <li class="row row--4">
      <ol class="cars" type="A">
        ...
        <li class="car">
          <input type="checkbox" id="4B" name="check" value="4B" <?php if($flag[9] || $bookflag[9]) echo 'disabled'; ?> />
    ...
    <li class="row row--5">
      <ol class="cars" type="A">
        ...
        <li class="car">
          <input type="checkbox" id="5B" name="check" value="5B" <?php if($flag[10] || $bookflag[10]) echo 'disabled'; ?>/>
